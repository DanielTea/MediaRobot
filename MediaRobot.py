...
def app():
    ...
    if authentication_status:
        ...
        uploaded_video = st.file_uploader('Upload Video *mp4 only!*', type=['mp4'], accept_multiple_files=False, key=None, help=None, on_change=None, disabled=False, label_visibility="visible")
